...
//
/**
 *    Aritm w/ sun.audio by M.O.B. as Java SE applet and application. 
 ...
 *    The source code is at http://www.df.lth.se/~mikaelb/aritm/sun.audio/
 *
 *    @version        1.0.5
...
public class AritmSunAudio extends Applet
{
   ...
   {
      if(_bSite)
         g.drawString("AritmSunAudio: Contact Mikael Bonnier, mikaelb@df.lth.se,"
...
class AritmSunAudioApp extends Frame
{
   public int Copyright__C__1997_Mikael_Bonnier__Lund__Sweden;
   private /* protected */ AritmSunAudio pnlAritm;
   ...
   {
      AritmSunAudioApp frm = new AritmSunAudioApp("AritmSunAudio");
      frm.pnlAritm = new AritmSunAudio();
      ...
      while(i < args.length && args[i].startsWith("-"))
      {
         ...
         if(arg.equals("-lang"))
            if(i < args.length)
               ...
               System.err.println("-lang require an en|sv|fi argument");
      }
   ...
   AritmSunAudioApp(String s)
   {
      ...
      mnu.add(mnuHelp);
      mnu.addSeparator();
      mnuAbout = new MenuItem("About AritmSunAudio");
      mnu.add(mnuAbout);
      setMenuBar(mnuBar);
   }
      ...
      switch(evt.id)
      {
         ...
         case Event.ACTION_EVENT:
            ...
            else if(evt.target.getClass().getName().equals("java.awt.MenuItem"))
            {
               ...
               {
                  Dialog dlg = new Dialog(this, "About AritmSunAudio", true);
